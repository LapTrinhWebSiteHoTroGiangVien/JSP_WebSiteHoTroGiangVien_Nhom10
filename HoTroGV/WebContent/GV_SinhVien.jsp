...
<body>
    ...
    <!-- Kết thúc Tạo một banner hiệu ứng chạy trên background -->
			...
			<table class="table table-bordered">
			    ...
			    <tbody>
			      <tr>
			        ...
			        <td>14110171</td>
			        <td>
			        	<button href="#" class="btn btn-info"><span class="glyphicon glyphicon-pencil" data-toggle="modal" data-target="#ChinhSuaTaiKhoan"></span> Sửa</button>
			        </td>
			         <td>	
		...
		<div  id ="demo" class="col-md4 col-md-offset-4">
			<button class="button" style="vertical-align:middle"><span data-toggle="modal" data-target="#ThemTaiKhoan">Thêm TK</span></a></button>
			<button class="button" onclick="loadDoc()" style="vertical-align:middle"><span>Xóa DSSV</span></button>
