...
<body>
    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                  ...
                  <td>
                  	<button type="button" class="btn btn-info"><span class="glyphicon glyphicon-pencil" data-toggle="modal" data-target="#SuaKeHoach"></span> Sửa</button>
        ...
        <div align="center">
        	<button type="button" class="btn btn-primary"><span data-toggle="modal" data-target="#ThemKeHoach">Thêm kế hoạch</span></button>
        </div>
