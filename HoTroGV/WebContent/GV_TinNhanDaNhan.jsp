			  ...
			  <div class="col-md-10">
			  	<div class="panel panel-primary">
					...
					<div class="panel-body">
					    ...
					    <div class="panel panel-success">
					      <div class="panel-heading"><h4><span class="glyphicon glyphicon-envelope"></span> Xin tài liệu HTML</h4></div>
					      <div class="panel-body">
					      	<p>Chào cô! Cho em xin tai liệu html được không ạ? E cảm ơn cô nhiều</p>
					      	<p>File: không có file</p>
					      	<p><span class="glyphicon glyphicon-user"></span> 14110166 | Nguyễn Trường Sang | 11/09/2016 07:00:58 PM</p>
					      </div>
					      <div class="panel-footer">
					      	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#TraLoiTinNhan"><span class="glyphicon glyphicon-send"></span></button>
					      	<button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></button>
