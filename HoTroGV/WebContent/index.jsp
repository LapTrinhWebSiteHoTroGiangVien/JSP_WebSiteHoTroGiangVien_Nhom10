	...
	<head>
      ...
      function Login(){
        ...
        if(flag == true && sv == true && gv == false){
          window.location = "SinhVien_TrangChu.html";
        }
        if(flag == true && gv == true && sv == false){
          window.location = "GV_TrangChu.html";
        }
        return flag;
      }
...
<!-- Kết thúc style button gvsv -->
    <!--Ket thuc js handin handout -->
</head>
<div class="container">
  <br>
      ...
      <div class="panel-heading" align="center"><h4>Hướng dẫn sử dụng trang web</h4></div>
       <div class="panel panel-info">
                ...
                <div class="panel-heading" align="center"><h4>Hướng dẫn đăng nhập</h4></div>
                    ...
                    <!-- Kết thúc Hide on Hide in GiangVien Sinh Vien -->
